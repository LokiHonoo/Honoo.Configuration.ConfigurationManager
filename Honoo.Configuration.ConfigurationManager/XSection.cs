...
namespace Honoo.Configuration
{
    ...
    public class XSection : XDictionary
    {
        ...
        internal XSection(XElement content, XComment comment) : base(content, comment, QueryProtected(content, out bool isProtected))
        {
        ...
        public void Decrypt(RSA protectionAlgorithm)
        {
            ...
            if (!_isProtected)
            {
                throw new CryptographicException($"Section is not encrypted.");
            }
        ...
        public void Encrypt(RSA protectionAlgorithm)
        {
            ...
            if (_isProtected)
            {
                throw new CryptographicException($"Section is encrypted yet.");
            }
